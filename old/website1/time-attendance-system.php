					...
					<div class="row">
							...
							<div class="sidebar">
								<div class="widget widget-recent-services">
									<ul>
										...
										<li><a href="time-attendance-system.php" class="active" title="">Time & Attendance System</a></li>
						...
						<div class="col-lg-8">
							<div class="content-details">
								...
								<h2>Time & Attendance System</h2>
								<h4>Significantly reduces attendance processing time and increases accuracy.</h4>
								<img src="assets/images/service/time.jpg" alt="">
								<p>Time-Attendance system is an automated attendance management software which records the attendance data of a user and generates various reports for the further actions. It does not only save administrative cost but also facilitates HR to centrally manage the attendance policies from multiple locations. Automatic calculation of overtime, leave balance, enables managers to work efficiently. </p>
							<p> These are advanced time & attendance systems to track and manage employee hours accurately. With easy-to-use interface and real-time information, they improve workforce productivity, reduce data entry errors, and save time. Its standalone or network based operation is ideal for Schools, Hospitals,Government Institutes, Banks, Remote Sites, Hotels,Small/Large Enterprises and many more..</p>
