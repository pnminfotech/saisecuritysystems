		...
		<section class="pager-sec overlay-dark">
			<div class="container">
				<div class="pager-sec-details">
					<h2>Cloud Based Attendance System<</h2>
					<ul class="breadcrumb">
					...
					<div class="row">
							...
							<div class="sidebar">
								<div class="widget widget-recent-services">
									<ul>
										...
										<li><a href="cloud-based-attendance-system.php"  class="active" title="">Cloud Based Attendance System</a> </li>
						...
						<div class="col-lg-8">
							<div class="content-details">
								...
								<h2>Cloud Based Attendance System</h2>
								<h4>No proprietary hardware or infrastructure required.</h4>
								<img src="assets/images/service/cloud-based-attendance-system.jpg" alt="">
								<p>Cloud-based Attendance System is for easyattendance management with basic access controlfunctions. With its user-friendly interface, small andmedium-size business (SMB) and enterprise userscan easily manage employee time-attendancerecording and access control for workers and visitors.Employees can report their attendance using GPSClocking, and device maintenance is easier than ever. </p>
							<p>With the integrated functions of man-hour estimation and operational efficiency parameters, it definitely calls for a more flexible and a judicious mechanism.  It can be used as an authentication method as it offers a reliable staff and student attendance system. </p>
