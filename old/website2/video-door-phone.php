					...
					<div class="row">
							...
							<div class="sidebar">
								<div class="widget widget-recent-services">
									<ul>
										...
										<li><a href="video-door-phone.php" class="active"  title="">Video Door Phone System</a> </li>
						...
						<div class="col-lg-8">
							<div class="content-details">
								...
								<h2>Video Door Phone System</h2>
								<h4>
 Significantly reduces attendance processing time and increases accuracy.</h4>
								<img src="assets/images/service/Video-Door-Phone.jpg" alt="">
								<p>With video door phones, you can always have a supervisory body that keeps a constant vigil to protect your home. As compared to traditional methods of hiring a security guard, keeping a watchdog, etc, a video door phone system is economical as well as reliable. </p>
							<p> Security and Automation can go hand-in-hand with Video Door Phone. These Video Door Phones facilitates two-way communication. With a clear speaker system, high-definition video and low power consumption, Video Door Phone is the best Surveillance Equipment used in both residential and commercial places.</p>
