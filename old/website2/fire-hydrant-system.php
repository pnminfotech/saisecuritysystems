...
<body>
					...
					<div class="row">
							...
							<div class="sidebar">
								<div class="widget widget-recent-services">
									<ul>
										...
										<li><a href="fire-hydrant-system.php" class="active"  title="">Fire Hydrant System</a> </li>
						...
						<div class="col-lg-8">
							<div class="content-details">
								...
								<h2>Fire Hydrant System</h2>
								<h4> We believe in delivering safety and not just fire safety equipment.</h4>
								<img src="assets/images/service/fire-hydrant-system.jpg" alt="">
								<p>We provide a comprehensive range of fire hydrantsystems that are commissioned on a turnkey basis..Fire hydrant installation consists of a system of pipework connected directly to the water supply main toprovide water to each and every hydrant outlet and isintended to provide water for the firemen to fight a fire.The water is discharged into the fire engine form whichit is then pumped and sprayed over fire. Where thewater supply is not reliable or inadequate, hydrantpumps should be provided to pressurize the fire mains.</p>
							<p>The location could be out of reach of sprinklers or it could be too developed for sprinklers or extinguishers to cope with. This is when firefighters step in. While firefighters have their own water tank, this can run dry very quickly. At such an eventuality, we need fire hydrants to boost the water supply.</p>
	...
	<section class="partner-background" style="">
