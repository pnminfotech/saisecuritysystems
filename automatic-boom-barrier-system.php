		...
		<section class="pager-sec overlay-dark">
			<div class="container">
				<div class="pager-sec-details">
					<h2>Automatic Boom Barrier System</h2>
					<ul class="breadcrumb">
					...
					<div class="row">
							...
							<div class="sidebar">
								<div class="widget widget-recent-services">
									<ul>
										...
										<li><a href="automatic-boom-barrier-system.php"  class="active" title="">Automatic Boom Barrier System</a> </li>
						...
						<div class="col-lg-8">
							<div class="content-details">
								...
								<h2>Automatic Boom Barrier System</h2>
								<h4>As safe and secure as you want them to be.</h4>
								<img src="https://ik.imagekit.io/bbbb375wr/service/automatic-boom-barriers.jpg" alt="">
								<p>We offer a high-quality boom barrier for securitypurposes. Boom barrier offers proficient security at theexit and entry-level of office, corporate houses, privateBuildings, parking areas way passage where mediumto heavy traffic expected. The main feature of ourboom barrier is high duty operation and the Doublespeed of the barrier guarantees brisk opening andshutting of the barrier with the delicate landing. </p>
							<p> The boom barriers replaced traditional manually operated ones to the automatic boom barriers. Taking in to the consideration the current scenario where we can see the digitalization of the Road traffic control and management system and digitalized approach towards everything there needs automatic boom barriers.</p>
