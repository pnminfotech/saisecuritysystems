					...
					<div class="row">
							...
							<div class="sidebar">
								<div class="widget widget-recent-services">
									<ul>
										...
										<li><a href="fire-alarm-system.php" class="active" title="">Fire Alarm System</a> </li>
						...
						<div class="col-lg-8">
							<div class="content-details">
								...
								<h2>Fire Alarm System</h2>
								<h4>Secure your industrial plant.</h4>
								<img src="https://ik.imagekit.io/bbbb375wr/service/fire-alarm-system.jpg" alt="">
								<p>A fire alarm system has a number of devices working together to detect and warn people through visual andaudio appliances when smoke, fire, carbon monoxideor other emergencies are present. These alarms maybe activated automatically from smoke detectors. Firealarms are found in Offices, Factories, and publicbuildings. they are a part of our everyday routine butare often overlooked until there is an emergency atwhich point, they might just save our lives.</p>
							<p>Fire Alarm System is designed to alert us to an emergency so that we can take action to protect ourselves, staff and the general public. The fire alarm system may also incorporate a remote signal system which could then alert the fire brigade via a central station.</p>
