					...
					<div class="row">
							...
							<div class="sidebar">
								<div class="widget widget-recent-services">
									<ul>
										...
										<li><a href="access-control-system.php"  class="active" title="">Access Control System</a></li>
						...
						<div class="col-lg-8">
							<div class="content-details">
								...
								<h2>Access Control System</h2>
								<h4>
                                Letting People in With Access Control Devices</h4>
								<img src="https://ik.imagekit.io/bbbb375wr/service/access-control-system.jpg" alt="">
								<p>Pertaining to the growing demand and securityconcerns, access control has always been vital forevery organization. Main objective of the AccessControl is to begin with – protect physical, IP andhuman assets. This requires restricting unauthorizedpeople from reaching pre-defined areas. Moreover,the basic question of who, where and when withadequate flexibility and scalability needs to beaddressed with door access control system.</p>
							<p> Here we help you identify the different types of commercial access control devices that are available on the market today so you can choose the ones that will make your business’s premises more secure.</p>
