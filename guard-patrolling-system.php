					...
					<div class="row">
							...
							<div class="sidebar">
								<div class="widget widget-recent-services">
									<ul>
										...
										<li><a href="guard-patrolling-system.php" class="active" title="">Guard Patrolling System</a> </li>
						...
						<div class="col-lg-8">
							<div class="content-details">
								...
								<h2>Guard Patrolling System</h2>
								<h4>Quickly schedule & stay updated on guard duties in real-time.</h4>
								<img src="https://ik.imagekit.io/bbbb375wr/service/guard-patrolling-system.jpg" alt="">
								<p>We are engaged in offering a wide range of guard toursystem in pune, guard patrol tour system that aresuitable for use in guard patrol environment. Theseguard tour system, guard patrol systems include I-button & RFID patrolling reader, rfid guard tour reader,guard tour patrol system, down loader, informationbutton for check points and others. Guard tour patrolsystems are procured from well-established vendorsof the market and equipped with advancedmicroprocessor electronics that assure reliability.</p>
							<p> The guard patrol system is a kind of management means for the manager to manage the patrol guards to arrive at the designated patrol place according to the prescribed time and the patrol route. Guard patrol system is also an important basis for performance appraisal.</p>
